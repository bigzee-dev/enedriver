        ...
        <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <div className="flex-1">
            ...
            <p className="mt-3 text-[#0A0A0A]/70 text-base font-medium italic">
              ...
              heavy-duty trucks and earth-moving machines — one accredited
              partner for the whole fleet.
            </p>
          </div>
          <a
            href="/courses"
            className="flex-shrink-0 inline-flex items-center gap-3 px-8 py-3 bg-[#0A0A0A]/90 text-white/80 font-display font-medium text-sm rounded-xl hover:bg-[#1A1A1A] transition-colors duration-300 uppercase"
          >
            View Courses
            <svg
              className="w-5 h-5"
